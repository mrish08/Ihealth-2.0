                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="dash-widget-header">
                                            <div class="float-end">
                                                <i class="uil-syringe widget-icon"></i>
                                            </div>
                                        ...
                                        <div class="dash-widget-info">
                                            <h5 class="text-muted">Total vaccination</h5>
                            ...
                            <div class="col-xl-3 col-sm-6 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="dash-widget-header">
                                            <div class="float-end">
                                                <i class="uil-clipboard-alt widget-icon"></i>
                                            </div>
                                            <div class="dash-count">
                                                <h3>487</h3>
                                            </div>
                                        ...
                                        <div class="dash-widget-info">
                                            ...
                                            <h5 class="text-muted">Total clinic</h5>
                                            <div class="progress progress-sm">
                            ...
                            <div class="col-xl-3 col-sm-6 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="dash-widget-header">
                                            <div class="float-end">
                                                <i class="mdi mdi-hospital widget-icon"></i>
                                            </div>
                                            <div class="dash-count">
                                                <h3>485</h3>
                                            </div>
                                        ...
                                        <div class="dash-widget-info">
                                            ...
                                            <h5 class="text-muted">Total dental clinic</h5>
                                            <div class="progress progress-sm">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="dash-widget-info">
                                            ...
                                            <h5 class="text-muted">Total Medicine pickup</h5>
                                            <div class="progress progress-sm">
