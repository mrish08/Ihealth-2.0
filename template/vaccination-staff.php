                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                <h4 class="page-title">Vaccination Appointments</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-xl-8">
                                                    <form class="row gy-2 gx-2 align-items-center justify-content-xl-start justify-content-between">
                                                        <div class="col-auto">
                                                            ...
                                                            <input type="search" class="form-control" id="inputPassword2" placeholder="Search..."> <br><br>
                                                        </div>
                                                    </form>
                                                </div>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-centered mb-0">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td><a href="apps-ecommerce-orders-details.html" class="text-body fw-bold">VA-0001</a> </td>
                                                                ...
                                                                <td>
                                                                    <span class="badge badge-info-lighten rounded-pill">Pending</span>
                                                                </td>
                                                                <td>
                                                                    <button type="button" class="btn btn-outline-success btn-rounded"><i class="dripicons-checkmark"></i></button>
                                                                    <button type="button" class="btn btn-outline-danger btn-rounded"><i class="mdi mdi-delete"></i></button>
                                                                </td>
                                                            </tr>

                                                            <tr>
                                                                <td><a href="apps-ecommerce-orders-details.html" class="text-body fw-bold">VA-0002</a> </td>
                                                                <td> Maria Leonora Teresa </td>
                                                            ...
                                                            <tr>
                                                                <td><a href="apps-ecommerce-orders-details.html" class="text-body fw-bold">VA-0003</a> </td>
                                                                <td> Maria Leonora Teresa </td>
                                                            ...
                                                            <tr>
                                                                <td><a href="apps-ecommerce-orders-details.html" class="text-body fw-bold">VA-0004</a> </td>
                                                                <td> Maria Leonora Teresa </td>
                                                            ...
                                                            <tr>
                                                                <td><a href="apps-ecommerce-orders-details.html" class="text-body fw-bold">VA-0005</a> </td>
                                                                <td> Maria Leonora Teresa </td>
                                                            ...
                                                            <tr>
                                                                <td><a href="apps-ecommerce-orders-details.html" class="text-body fw-bold">VA-0006</a> </td>
                                                                <td> Maria Leonora Teresa </td>
                                                            ...
                                                            <tr>
                                                                <td><a href="apps-ecommerce-orders-details.html" class="text-body fw-bold">VA-0007</a> </td>
                                                                <td> Maria Leonora Teresa </td>
                                                            ...
                                                            <tr>
                                                                <td><a href="apps-ecommerce-orders-details.html" class="text-body fw-bold">VA-0008</a> </td>
                                                                <td> Maria Leonora Teresa </td>
                                                            ...
                                                            <tr>
                                                                <td><a href="apps-ecommerce-orders-details.html" class="text-body fw-bold">VA-0009</a> </td>
                                                                <td> Maria Leonora Teresa </td>
                                                            ...
                                                            <tr>
                                                                <td><a href="apps-ecommerce-orders-details.html" class="text-body fw-bold">VA-0010</a> </td>
                                                                <td> Maria Leonora Teresa </td>
